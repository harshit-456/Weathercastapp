 ...
 */
public final class WeatherCastWeatherUtils {

    private static final String LOG_TAG = WeatherCastWeatherUtils.class.getSimpleName();
    ...
    public static String formatTemperature(Context context, double temperature) {
        if (!WeatherCastPreferences.isMetric(context)) {
