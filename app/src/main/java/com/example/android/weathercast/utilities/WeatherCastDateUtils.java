...
/**
 * Class for handling date conversions that are useful for WeatherCast.
 */
public final class WeatherCastDateUtils {
     ...
     *
     * Normalize, in our usage within WeatherCast means to convert a given date in milliseconds to
