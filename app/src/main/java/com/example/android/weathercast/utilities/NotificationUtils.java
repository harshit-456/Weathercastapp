...
import com.example.android.weathercast.DetailActivity;
...
public class NotificationUtils {
    ...
    public static void notifyUserOfNewWeather(Context context) {
        ...
        Uri todaysWeatherUri = WeatherContract.WeatherEntry
                .buildWeatherUriWithDate(WeatherCastDateUtils.normalizeDate(System.currentTimeMillis()));
        ...
        if (todayWeatherCursor.moveToFirst()) {
            ...
            int largeArtResourceId = WeatherCastWeatherUtils
            ...
            int smallArtResourceId = WeatherCastWeatherUtils
             ...
             * we want to open WeatherCast to the DetailActivity to display the newly updated weather.
             */
             ...
             */
            WeatherCastPreferences.saveLastNotificationTime(context, System.currentTimeMillis());
        }
    ...
    private static String getNotificationText(Context context, int weatherId, double high, double low) {
         ...
         */
        String shortDescription = WeatherCastWeatherUtils
        ...
        String notificationText = String.format(notificationFormat,
                shortDescription,
                WeatherCastWeatherUtils.formatTemperature(context, high),
                WeatherCastWeatherUtils.formatTemperature(context, low));
