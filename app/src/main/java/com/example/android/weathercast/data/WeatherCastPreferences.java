...
public final class WeatherCastPreferences {
    ...
    /**
     * Returns true if the user prefers to see notifications from WeatherCast, false otherwise. This
    ...
    public static boolean areNotificationsEnabled(Context context) {
        ...
        /*
         * In WeatherCast, the user has the ability to say whether she would like notifications
    ...
    public static long getLastNotificationTimeInMillis(Context context) {
        /* Key for accessing the time at which WeatherCast last displayed a notification */
    ...
    public static long getEllapsedTimeSinceLastNotification(Context context) {
        long lastNotificationTimeMillis =
                WeatherCastPreferences.getLastNotificationTimeInMillis(context);
