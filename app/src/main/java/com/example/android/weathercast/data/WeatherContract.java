...
public class WeatherContract {
     ...
     * Play Store.
     */
    public static final String CONTENT_AUTHORITY = "com.example.android.weathercast";

    /*
     * Use CONTENT_AUTHORITY to create the base of all URI's which apps will use to contact
     * the content provider for WeatherCast.
     */
    public static final Uri BASE_CONTENT_URI = Uri.parse("content://" + CONTENT_AUTHORITY);

    /*
     * Possible paths that can be appended to BASE_CONTENT_URI to form valid URI's that WeatherCast
     ...
     *
     *      content://com.example.android.weathercast/givemeroot/
     *
    ...
    public static final class WeatherEntry implements BaseColumns {
        ...
        public static String getSqlSelectForTodayOnwards() {
            long normalizedUtcNow = WeatherCastDateUtils.normalizeDate(System.currentTimeMillis());
