 ...
 */
package com.example.android.weathercast.data;
...
import com.example.android.weathercast.utilities.WeatherCastDateUtils;

/**
 * This class serves as the ContentProvider for all of WeatherCast's data. This class allows us to
...
public class WeatherProvider extends ContentProvider {
    ...
    public static UriMatcher buildUriMatcher() {
         ...
         * they aren't going to change. In WeatherCast, we use CODE_WEATHER or CODE_WEATHER_WITH_DATE.
         */

        /* This URI is content://com.example.android.weathercast/weather/ */
        matcher.addURI(authority, WeatherContract.PATH_WEATHER, CODE_WEATHER);

        /*
         * This URI would look something like content://com.example.android.weathercast/weather/1472214172
    ...
    /**
     * Handles requests to insert a set of new rows. In WeatherCast, we are only going to be
            ...
            case CODE_WEATHER:
                ...
                try {
                    for (ContentValues value : values) {
                        ...
                        if (!WeatherCastDateUtils.isDateNormalized(weatherDate)) {
    ...
    /**
     * Handles query requests from clients. We will use this method in WeatherCast to query for all
    ...
    public Cursor query(@NonNull Uri uri, String[] projection, String selection,
        ...
        switch (sUriMatcher.match(uri)) {
             ...
             *
             *      content://com.example.android.weathercast/weather/1472214172
             *
             ...
             *
             *      content://com.example.android.weathercast/weather/
             *
             * sUriMatcher's match method will return the code that indicates to us that we need
    ...
    /**
     * In WeatherCast, we aren't going to do anything with this method. However, we are required to
     ...
     *
     * @param uri the URI to query.
     * @return nothing in WeatherCast, but normally a MIME type string, or null if there is no type.
     */
    @Override
    public String getType(@NonNull Uri uri) {
        throw new RuntimeException("We are not implementing getType in WeatherCast.");
    }
     ...
     * @return nothing in WeatherCast, but normally the URI for the newly inserted item.
     */
    @Override
    public Uri insert(@NonNull Uri uri, ContentValues values) {
        throw new RuntimeException(
                "We are not implementing insert in WeatherCast. Use bulkInsert instead");
    }

    @Override
    public int update(@NonNull Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        throw new RuntimeException("We are not implementing update in WeatherCast");
    }
