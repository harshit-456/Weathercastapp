...
import com.example.android.weathercast.utils.PollingCheck;
...
import static com.example.android.weathercast.data.WeatherContract.WeatherEntry.COLUMN_DATE;
import static com.example.android.weathercast.data.WeatherContract.WeatherEntry.COLUMN_DEGREES;
import static com.example.android.weathercast.data.WeatherContract.WeatherEntry.COLUMN_HUMIDITY;
import static com.example.android.weathercast.data.WeatherContract.WeatherEntry.COLUMN_MAX_TEMP;
import static com.example.android.weathercast.data.WeatherContract.WeatherEntry.COLUMN_MIN_TEMP;
import static com.example.android.weathercast.data.WeatherContract.WeatherEntry.COLUMN_PRESSURE;
import static com.example.android.weathercast.data.WeatherContract.WeatherEntry.COLUMN_WEATHER_ID;
import static com.example.android.weathercast.data.WeatherContract.WeatherEntry.COLUMN_WIND_SPEED;
...
class TestUtilities {
    ...
    static ContentValues[] createBulkInsertTestWeatherValues() {
        ...
        long normalizedTestDate = WeatherCastDateUtils.normalizeDate(testDate);

        for (int i = 0; i < BULK_INSERT_RECORDS_TO_INSERT; i++) {

            normalizedTestDate += WeatherCastDateUtils.DAY_IN_MILLIS;
