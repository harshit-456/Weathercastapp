...
import static com.example.android.weathercast.data.TestUtilities.getConstantNameByStringValue;
import static com.example.android.weathercast.data.TestUtilities.getStaticIntegerField;
import static com.example.android.weathercast.data.TestUtilities.getStaticStringField;
import static com.example.android.weathercast.data.TestUtilities.studentReadableClassNotFound;
import static com.example.android.weathercast.data.TestUtilities.studentReadableNoSuchField;
...
/**
 * Used to test the database we use in WeatherCast to cache weather data. Within these tests, we
 * test the following:
 * <p>
 * <p>
...
public class TestWeatherCastDatabase {
     ...
     */
    private static final String packageName = "com.example.android.weathercast";
...
>>>>>>> 4174cf2... S07.02-Exercise-PreventInvalidInserts
     ...
     * <p>
     * {@link com.example.android.weathercast.data.WeatherContract.WeatherEntry#TABLE_NAME}.
     * <p>
     * Despite only needing to check one table name in WeatherCast, we set this method up so that
